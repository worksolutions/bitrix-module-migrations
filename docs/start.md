...
ƒл€ старта успешного применени€ модул€ миграций в проекте необходимо произвести инициализацию начального состо€ни€,
...
3. ѕри помощи функцинала резервного копировани€ подготовить копию данных актуальной версии
